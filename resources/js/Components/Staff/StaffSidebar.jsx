      ...
      <ul className={`nav flex-column mt-3${isOpen ? "" : " d-none"}`}>
        <li className="nav-item">
          <a className="nav-link text-white d-flex align-items-center" href="/dashboard">
            <i className="bx bx-home-circle me-2"></i> Dashboard
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link text-white d-flex align-items-center" href="/all-category">
            <i className="bx bx-right-arrow-alt me-2"></i> All Category
          </a>
        </li>
